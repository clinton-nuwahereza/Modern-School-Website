...
<div class="col-md-<?php if ($eyepress_post_sidebar == 'no-sidebar') : ?>4<?php else : ?>6<?php endif; ?> mobi-mb-30 <?php echo esc_attr($eyepress_img_class); ?> <?php if ($eyepress_grid_type == 'mesonry') : ?>masonry-entry<?php else : ?>fixed-height<?php endif; ?>">
