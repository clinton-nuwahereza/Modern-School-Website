...
if (!function_exists('eyepress_scripts')) :
	function eyepress_scripts()
	{
		...
		// RTL support: enqueue rtl.css automatically if is_rtl()
		if ( is_rtl() ) {
			wp_enqueue_style( 'eyepress-rtl', get_template_directory_uri() . '/rtl.css', array('eyepress-style'), EYEPRESS_VERSION, 'all' );
		}
