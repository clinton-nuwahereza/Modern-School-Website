...
<div id="help-panel" class="panel-left">
    ...
    <div class="panel-aside">
        <h4><?php esc_html_e( 'Documentation', 'school-education' ); ?></h4>
        <p><?php esc_html_e( 'Explore the comprehensive guide and instructions for this WordPress Theme. Begin your journey with assurance.', 'school-education' ); ?></p>
        <a class="button button-primary" href="<?php echo esc_url( SCHOOL_EDUCATION_DOCUMENTATION ); ?>" title="<?php esc_attr_e( 'Visit the doc', 'school-education' ); ?>" target="_blank">
            <?php esc_html_e( 'Documentation', 'school-education' ); ?>
        </a>
    </div><!-- .panel-aside -->
