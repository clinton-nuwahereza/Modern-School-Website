            ...
            <div class="welcome-text-main">
                <div>
                    <div class="welcome-heding">
                        <h1 class="welcome-text-title"><?php echo esc_html__('Welcome to','school-education'); ?> <strong><?php echo esc_html__('School Education Theme','school-education'); ?> </strong></h1>
                    </div>
