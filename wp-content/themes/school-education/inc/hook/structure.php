...
if ( ! function_exists( 'school_education_footer_end' ) ) :
	...
	function school_education_footer_end() {
		...
		$school_education_enable_cursor_dot_outline = school_education_get_option('school_education_enable_cursor_dot_outline');
		if ($school_education_enable_cursor_dot_outline) { ?>
			<!-- Custom cursor -->
