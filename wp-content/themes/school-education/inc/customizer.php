...
function school_education_logo_customize_register( WP_Customize_Manager $wp_customize ) {
	...
	$wp_customize->add_control( 'logo_size', array(
		'label'       => esc_html__( 'Logo Size','school-education' ),
...
add_action( 'customize_register', 'school_education_logo_customize_register' );