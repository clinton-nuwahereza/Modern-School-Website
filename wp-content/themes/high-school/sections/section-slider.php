...
$read_more      = get_theme_mod( 'education_zone_banner_read_more', __( 'Read More', 'high-school' ) );
$title          = get_theme_mod( 'education_zone_banner_title', __( 'Better Education for a Better World', 'high-school' ) );
$description    = get_theme_mod( 'education_zone_banner_description', __( 'Maecenas perspiciatis eleifend mollitia esse etiam rem harum? Sunt incididunt, sollicitudin earum anim quidem laoreet nibh, facilisis eiusmod!', 'high-school' ) );
$link_one_label = get_theme_mod( 'education_zone_banner_link_one_label', __( 'Get Started Now', 'high-school' ) );
$link_one_url   = get_theme_mod( 'education_zone_banner_link_one_url', '#' );
$link_two_label = get_theme_mod( 'education_zone_banner_link_two_label', __( 'Enquiry', 'high-school' ) );
