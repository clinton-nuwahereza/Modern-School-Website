...
function prime_playschool_classes_sanitize_post_layout($input) {
...
function prime_playschool_classes_sanitize_single_post_align($input) {
...
function prime_playschool_classes_sanitize_scroll_top_alignment($input) {
...
function prime_playschool_classes_sanitize_pagination_alignment($input) {
    $valid = array('right-align', 'center-align', 'left-align');
...
function prime_playschool_classes_sanitize_sortable( $val, $setting ) {
