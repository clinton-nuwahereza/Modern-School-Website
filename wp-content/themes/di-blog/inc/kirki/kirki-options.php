...
Kirki::add_field( 'di_blog_config', array(
	...
	'active_callback'  => function() {
		return has_custom_logo() ? false : true;
	}
) );
...
Kirki::add_field( 'di_blog_config', array(
	...
	'label'       => esc_attr__( 'Page / Post Heading Typography', 'di-blog' ),
	'description' => esc_attr__( 'Typography for page and post heading.', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'h1_typog',
	'label'       => esc_attr__( 'Heading 1 (H1) Typography', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Open Sans',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => 'body h1:not(.elementor-element h1), .h1:not(.elementor-element h1)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'h2_typog',
	'label'       => esc_attr__( 'Heading 2 (H2) Typography', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Open Sans',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => 'body h2:not(.elementor-element h2), .h2:not(.elementor-element h2)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'h3_typog',
	'label'       => esc_attr__( 'Heading 3 (H3) Typography', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Arvo',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => 'body h3:not(.elementor-element h3), .h3:not(.elementor-element h3)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'h4_typog',
	'label'       => esc_attr__( 'Heading 4 (H4) Typography', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Arvo',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => 'body h4:not(.elementor-element h4), .h4:not(.elementor-element h4)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'h5_typog',
	'label'       => esc_attr__( 'Heading 5 (H5) Typography', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Arvo',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => 'body h5:not(.elementor-element h5), .h5:not(.elementor-element h5)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'h6_typog',
	'label'       => esc_attr__( 'Heading 6 (H6) Typography', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
		'font-family'    => 'Arvo',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => 'body h6:not(.elementor-element h6), .h6:not(.elementor-element h6)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	...
	'output'      => array(
		array(
			'element' => 'body .maincontainer p:not(.elementor-element p), .footer-widgets p',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	...
	'description' => esc_attr__( 'Typography for list in main container', 'di-blog' ),
	'section'     => 'typography_options',
	'default'     => array(
	...
	'output'      => array(
		array(
			'element' => '.maincontainer .entry-content ul li:not(.elementor-element ul li), .maincontainer .entry-content ol li:not(.elementor-element ol li)',
		),
	),
	'transport' => 'auto',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'			=> 'text',
	'settings'		=> 'sprofile_link_tiktok',
	'label'			=> esc_attr__( 'TikTok Link', 'di-blog' ),
	'description'	=> esc_attr__( 'Leave empty for disable', 'di-blog' ),
	'section'		=> 'social_options',
	'default'		=> '',
) );
...
Kirki::add_field( 'di_blog_config', array(
	'type'        => 'typography',
	'settings'    => 'ftr_wdgt_hdg_typog',
	'label'       => esc_attr__( 'Widget Heading Typography', 'di-blog' ),
	'section'     => 'ftr_wdgt_options',
	'default'     => array(
		'font-family'    => 'Arvo',
		'variant'        => 'regular',
	...
	'output'      => array(
		array(
			'element' => '.footer-widgets .widgets_footer .widgets_footer_title',
		),
	),
	'transport' => 'auto',
	'active_callback'  => array(
