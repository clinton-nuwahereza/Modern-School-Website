...
<body <?php body_class(); ?>>
	<div id="page" class="site">
		...
		<div class="home-banner">
			...
			<!-- Header Section End -->
			<?php
			$personal_eye_header_img_show = get_theme_mod('personal_eye_header_img_show', 1);
			if (is_front_page() && $personal_eye_header_img_show == 1 || is_home() && $personal_eye_header_img_show == 1) {
