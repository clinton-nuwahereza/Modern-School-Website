...
*
*/
$eyepress_welcome_text = get_theme_mod('eyepress_welcome_text', __('Hello! MY NAME IS', 'personal-eye'));
$eyepress_author_name = get_theme_mod('eyepress_author_name', __('JAMES R.TIDWELL', 'personal-eye'));
$eyepress_author_designation = get_theme_mod('eyepress_author_designation');
$eyepress_header_desc = get_theme_mod('eyepress_header_text', __('I\'M Passionate About Programming, Graphics And Photography', 'personal-eye'));
$eyepress_btn_text_one = get_theme_mod('eyepress_btn_text_one', __('Contact Me', 'personal-eye'));
$eyepress_btn_url_one = get_theme_mod('eyepress_btn_url_one', '#');
$eyepress_btn_text_two = get_theme_mod('eyepress_btn_text_two', __('Learn More', 'personal-eye'));
