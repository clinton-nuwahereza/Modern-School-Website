 ...
 * @package eyepress
 */
$eyepress_copytext_default = '<a href="' . esc_url(__('https://wordpress.org/', 'personal-eye')) . '">' . esc_html__('Proudly powered by WordPress', 'personal-eye') . '</a> <span class="sep"> | </span>' . esc_html__('Theme: EyePress by', 'personal-eye') . ' <a href="' . esc_url('https://wpthemespace.com/') . '">' . esc_html__('wp theme space', 'personal-eye') . '</a>';

$eyepress_footer_position = get_theme_mod('eyepress_footer_position', 'center');
if ($eyepress_footer_position == 'default') {
	$eyepress_footer_class1 = 'col-xs-12 col-lg-6';
	$eyepress_footer_class2 = 'col-xs-12 col-lg-6 text-right';
} else {
