...
if ( ! class_exists( 'Business_School_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Business_School_WPTT_WebFont_Loader {
		...
		public function get_remote_url_contents() {
			...
			$business_school_contents = wp_remote_retrieve_body( $response );

			return $business_school_contents;
		}
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Business_School_WPTT_WebFont_Loader( $url );
