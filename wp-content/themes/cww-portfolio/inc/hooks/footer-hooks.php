		...
		<footer id="colophon" class="site-footer">
			...
			<div class="site-info cww-flex">
				...
				<span class="sep"> | </span>
					...
					printf( esc_html__( 'Theme: %1$s by %2$s.', 'cww-portfolio' ), '<a href="https://codeworkweb.com/themes/cww-portfolio" class="th-name">'.esc_html($cww_get_current_theme->Name).'</a>', 'Code Work Web' );
					?>
			</div><!-- .site-info -->
			</div>
		</footer><!-- #colophon -->
